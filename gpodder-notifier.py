...
if text_pending[0] == "#" :
	action_mark_old = "--action=Mark as old:python /media/Datos/GDrive/check-gpodder/mark-gpodder.py"
...
#subprocess.call(['./notify-send.sh', icon, action_open, action_download, action_default, head, msg])
#subprocess.call(['/media/Datos/GDrive/check-gpodder/notify-send.sh', icon, action_open, action_mark_old, action_download, action_default, head, msg])
